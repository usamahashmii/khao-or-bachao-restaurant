(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["item-edit-item-edit-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppItemEditItemEditPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppItemEditItemEditRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ItemEditPageRoutingModule", function () {
        return ItemEditPageRoutingModule;
      });
      /* harmony import */
      ...
      var _item_edit_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./item-edit.page */
      ...
      var ItemEditPageRoutingModule = function ItemEditPageRoutingModule() {
        _classCallCheck(this, ItemEditPageRoutingModule);
      };

      ItemEditPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppItemEditItemEditModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ItemEditPageModule", function () {
      ...
      var _item_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./item-edit-routing.module */
      "./src/app/item-edit/item-edit-routing.module.ts");
      /* harmony import */


      var _item_edit_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./item-edit.page */
      "./src/app/item-edit/item-edit.page.ts");
      /* harmony import */
      ...
      var ItemEditPageModule = function ItemEditPageModule() {
        _classCallCheck(this, ItemEditPageModule);
      };

      ItemEditPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        exports: [_angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _item_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__["ItemEditPageRoutingModule"], _pipes_module__WEBPACK_IMPORTED_MODULE_1__["PipesModule"]],
    ...
    /***/
    function srcAppItemEditItemEditPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppItemEditItemEditPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ItemEditPage", function () {
        return ItemEditPage;
      });
      /* harmony import */
      ...
      var ItemEditPage = /*#__PURE__*/function () {
        function ItemEditPage(toastservice, formBuilder, router, loader, storage, alertCtrl, imageService, alertService, activatedRoute, restService) {
          var _this = this;

          _classCallCheck(this, ItemEditPage);
          ...
          this.activatedRoute.queryParams.subscribe(function (res) {
            ...
            _this.itemName = _this.itemData.data.item_name;
            _this.measurement = _this.itemData.data.measurement;
            _this.quantity = _this.itemData.data.quantity;
            _this.itemPrice = _this.itemData.data.price;
            _this.priceRange = _this.itemData.data.price_range;
            _this.categoryItemValue = _this.itemData.data.categories_id;
            _this.menuImg = _this.itemData.data.item_image_url;
            _this.items_id = _this.itemData.data.items_id;
          });
        ...
        _createClass(ItemEditPage, [{
          ...
          key: "ngOnInit",
          value: function ngOnInit() {} //Take profile picture
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this3.takeImageFromCamera();
                          }
                        }, {
                          text: 'Get photo from gallery',
                          handler: function handler() {
                            _this3.getImageFromGallery();
                          }
                        }]
                      });
          ...
          value: function takeImageFromCamera() {
            ...
            this.imageService.selectImageInCamera().then(function (imageData) {
              _this4.menuImg = "data:image/png;base64,".concat(imageData);

              var data = _this4.menuImg.split(';base64,');

              _this4.serverImageData = data[1];
            })["catch"](function (err) {
          ...
          value: function submitItemData() {
            ...
            if (!this.addMenuform.valid) {
              ...
              this.storage.get('user_accounts_id').then(function (user_accounts_id) {
                _this6.userId = user_accounts_id;
                var stringy = JSON.stringify({
                  requestType: 'update',
                  restaurantId: _this6.resaturant_id,
                  itemName: _this6.itemName,
                  price: _this6.itemPrice,
                  categoryId: _this6.categoryItemValue,
                  measurement: _this6.measurement,
                  quantity: _this6.quantity,
                  itemImage: _this6.serverImageData,
                  priceRange: _this6.priceRange,
                  itemId: _this6.items_id
                });
                console.log(stringy);

                _this6.loader.presentLoader();

                _this6.restService.saveSingleItem(stringy).subscribe(function (response) {
                  _this6.restaurant_data = JSON.parse(response['_body']);
                  console.log(_this6.restaurant_data);

                  _this6.toastservice.presentToastItemEdit();

                  _this6.router.navigate(['/tabs/menu']);

                  _this6.loader.hideLoader();
                }, function (err) {
                  _this6.loader.hideLoader();

                  _this6.alertService.presentAlertService(err);
                });
              });
            }
          }
      ...
      ItemEditPage.ctorParameters = function () {
        return [{
      ...
      ItemEditPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-item-edit',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./item-edit.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/item-edit/item-edit.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./item-edit.page.scss */
        "./src/app/item-edit/item-edit.page.scss"))["default"]]
      })], ItemEditPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=item-edit-item-edit-module-es5.js.map