  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["notifications-notifications-module"], {
    ...
    function srcAppNotificationsNotificationsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotificationsPage = /*#__PURE__*/function () {
        function NotificationsPage(menuCtrl, storage, loader, alertService, toastService, restService) {
        ...
        _createClass(NotificationsPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.storage.get('restaurants_id').then(function (restaurants_id) {
              _this2.storage.get('email').then(function (email) {
                ...
                _this2.loader.presentLoader();

                _this2.restService.getNotifications(stringy).subscribe(function (response) {
                  console.log(response['_body']);
                  _this2.notifications = JSON.parse(response['_body']);
                  _this2.notifications = _this2.notifications.notifications;
      ...
      NotificationsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
