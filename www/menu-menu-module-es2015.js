...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _alert_confirm_alert_confirm_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../alert-confirm/alert-confirm.module */ "./src/app/alert-confirm/alert-confirm.module.ts");
...
/* harmony import */ var _menu_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./menu-routing.module */ "./src/app/menu/menu-routing.module.ts");
/* harmony import */ var _menu_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./menu.page */ "./src/app/menu/menu.page.ts");
/* harmony import */ var _pipes_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../pipes.module */ "./src/app/pipes.module.ts");
...
MenuPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _alert_confirm_alert_confirm_module__WEBPACK_IMPORTED_MODULE_1__["AlertConfirmPageModule"],
            _pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"]
        ],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _alert_confirm_alert_confirm_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../alert-confirm/alert-confirm.page */ "./src/app/alert-confirm/alert-confirm.page.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let MenuPage = class MenuPage {
    constructor(loader, restService, router, alertService, storage, menuCtrl, toastController, popoverController, alertController) {
        this.loader = loader;
    ...
    itemEdit(data, i) {
        ...
        btn.addEventListener("click", (e) => this.itemdismiss(data, i));
        /* btn dismiss */
        /* btn edit */
        let btnEdit = document.querySelector('.single_item_edit_' + i + '');
        btnEdit.addEventListener("click", (e) => this.signleitemEdit(data, i));
        /* btn edit */
        /* btn delete */
        let btnDelete = document.querySelector('.single_item_delete_' + i + '');
        btnDelete.addEventListener("click", (e) => this.itemdelete(data, i));
        /* btn delete */
    }
    itemdelete(data, i) {
        this.AlertConfirm(data.items_id, i);
    }
    AlertConfirm(items_id, i) {
    ...
    presentAlertConfirm(items_id, i) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    itemdismiss(data, i) {
        ...
        btn.addEventListener("click", (e) => this.itemEdit(data, i));
    }
};
